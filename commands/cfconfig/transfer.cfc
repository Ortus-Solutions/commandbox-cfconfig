...
component {
	...
	property name='moduleSettings' inject='commandbox:moduleSettings:commandbox-cfconfig';
	...
	*/	
	function run(
		...
		print.greenLine( 'Config transferred from #fromDetails.path# to #toDetails.path#!' );
	}
